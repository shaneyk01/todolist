...
def main():
    ...
    tasks = []#creates empty list to store tasks.
#menu runs infinite loop until user chooses option 4 to exit
    while True:
...
#asks user to choose option with input() function
        if choice == '1':
            add_task(tasks)
        elif choice == '2':
            display_tasks(tasks)
